...
class AppRoot extends Component {
    constructor() {
        ...
        this.state = { tracks: [], autoPlay: false, activeSong: {}, showPlayer: false, nowPlaying: false };

    }
    setNowPlaying(bol) {
        this.setState({ nowPlaying: bol });
    }
    ...
    render() {
        return (
            <BrowserRouter>
                <div className="main">
                    <Header setNowPlaying={this.setNowPlaying} showPlayer={this.state.showPlayer} activeSong={this.state.activeSong} setPreviousTrack={this.setPreviousTrack} setNextTrack={this.setNextTrack} autoPlay={this.state.autoPlay} pad={this.pad} setTrackList={this.setTrackList} apiUrl={this.apiUrl} token={this.token} auth={this.auth} />
                    <Route exact path="/" render={() => <App activeSongId={this.state.activeSong.id} nowPlaying={this.state.nowPlaying} setActiveSong={this.setActiveSong} pad={this.pad} tracks={this.state.tracks} setTrackList={this.setTrackList} apiUrl={this.apiUrl} token={this.token} auth={this.auth} />} />
